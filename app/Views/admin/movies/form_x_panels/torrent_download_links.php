...
<div class="x_content">
    ...
    <div  id="torrent-dl-group-content">
        ...
        <?php if(! empty($torrentDownloadLinks)): ?>
            <?php foreach ($torrentDownloadLinks as $key => $link):
                ...
                <div class="main-form-group torrent-dl-group">
                    ...
                    <input type="hidden" name="torrent_dl_links[<?= $key ?>][id]" class="link-id" value="<?= $link->id ?>" >
    ...
    <div class="text-right">
        <button type="button" class="btn btn-light font-weight-bold" id="clone-torrent-dl-group">

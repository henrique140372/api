    ...
    earnByMonthly: {
        ...
        updateChart: function (){
            ...
            $.ajax({
                ...
                url: BASE_URL  + '/user/statistics/json',
                type: 'GET',
    ...
    referralsByMonthly: {
        ...
        init: function () {
            ...
            if(typeof ReferralsByMonthly_LineChart != 'undefined'){
                ...
                self.dateRangePicker = $('#referrals-by-monthly-datetime-picker');
                self.bindDataRangePicker();
                self.updateChart();
            }
        },
    ...
    referralsByCountriesMap: {
        ...
        init: function () {
            ...
            if(visitorsMap.length === 1){
                ...
                self.dateRangePicker = $('#referrals-by-countries-datetime-picker');
                self.bindDataRangePicker();
        ...
        updateMap: function (){
            ...
            $.ajax({
                ...
                error: function (jqXHR, exception){
                    alert('Ref map data loading failed');
                },
                complete: function() {
                    setTimeout(function (){
                        self.load();
